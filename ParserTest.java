...
public class ParserTest {
    ...
    */
    ...
    @Test
    public void testA() {
        assertEquals("Unexpected (", ylp.parse("(((((a)))))#"));
    }@Test
    public void testB() {
        assertEquals("Unexpected r", ylp.parse("rute"));
    }@Test
    public void testC() {
        assertEquals("R1,R2,R2,R2,R2,R2,R2,R2,R2,R2,R3", ylp.parse("aaaaaaaaab#"));
    }@Test
    public void testD() {
        assertEquals("Unexpected y", ylp.parse("ayalew"));
    }
