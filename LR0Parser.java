...
public class LR0Parser {
    ...
    public String getDerivation() {
        ...
        StringBuilder dString = new StringBuilder(derivationString);
        // TODO
        int i = 0;
        String current = "";
        while(derivation.isEmpty()==false){
            current = derivation.pop();
            dString.append(current);
            if ((derivation.size()>0)&& (Character.isDigit(String.valueOf(current).charAt(1))==true)) {
                dString.append(",");
            }
            i++;
        }

        /*while(i<derivation.size()){
             current = derivation.pop();
             myArray[i]= current;
             i++;
        }
        i=myArray.length-1;
        while(i>=0) {
            dString.append(myArray[i]);
            if ((i!=0)&& (Character.isDigit(String.valueOf(myArray[i]).charAt(0))==true)) {
                dString.append(", ");
            }
            i--;
        }*/
        derivationString = String.valueOf(dString);
        // END TODO
    ...
    public String getError() {
        ...
        // TODO
        sbuilder.append(currentSymbol);
        errorMessage = String.valueOf(sbuilder);
    ...
    public String parse(String word) {
        ...
        while (remainingInput.length() > 0) {
            ...
            // see Project Description document
                ...
                remainingInput = String.valueOf(sb.deleteCharAt(0));
                // END TODO
            }
